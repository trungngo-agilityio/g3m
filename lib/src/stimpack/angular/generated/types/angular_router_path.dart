...
class StimAngularRouterPathRef extends StimSymbolRef<StimAngularRouterPath>
    implements StimAngularRouterPath {}

class StimAngularRouterPathScope {
  /// Creates a new "routerPath" of [StimAngularRouterPath] type.
  StimAngularRouterPath of(
      {dynamic name,
      String path,
      StimAngularRouterPath parent,
      Set<StimAngularRouterParam> params,
