...
class StimAngularRouterRedirect
    extends StimModelSymbol<StimAngularRouterRedirect> {
  ...
  StimAngularRouterRedirect refWith(
...
class StimAngularRouterRedirectRef
    extends StimSymbolRef<StimAngularRouterRedirect>
    implements StimAngularRouterRedirect {}

class StimAngularRouterRedirectScope {
  /// Creates a new "routerRedirect" of [StimAngularRouterRedirect] type.
  StimAngularRouterRedirect of(
      {dynamic name, StimAngularRouterPath path, Set<StimModelTag> tags}) {
