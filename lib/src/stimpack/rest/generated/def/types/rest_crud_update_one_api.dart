...
class StimRestCrudUpdateOneApi extends StimModelSymbol<StimRestCrudUpdateOneApi> {
  ...
  StimRestCrudUpdateOneApi refWith({dynamic name, StimModelField idField, StimRbacPolicy policy, Set<StimModelField> response, Set<StimModelTag> tags}) {
    final res = ref();
    if (name != null) {
...
class StimRestCrudUpdateOneApiScope {
  /// Creates a new "crudUpdateOneApi" of [StimRestCrudUpdateOneApi] type.
  StimRestCrudUpdateOneApi of({dynamic name, StimModelField idField, StimRbacPolicy policy, Set<StimModelField> response, Set<StimModelTag> tags}) {
