...
class StimRbacAccessRole extends StimSymbol<StimRbacAccessRole, StimRbacAccessRoleSet> {
  StimRbacAccessPermissionSet permissions;

  StimRbacAccessRole(_StimRbacAccessRoleScopeImpl scope):
      super(scope);
...
class StimRbacAccessRoleSet extends StimSymbolSet<StimRbacAccessRole, StimRbacAccessRoleSet> {
  ...
  StimRbacAccessRoleXPermissionsSetOp get permissions {
    return _permissions ??= StimRbacAccessRoleXPermissionsSetOp(this, stimpack.rbac.accessPermission);
  }
...
abstract class StimRbacAccessRoleScope extends StimScope<StimRbacAccessRole, StimRbacAccessRoleSet> {
...
class _StimRbacAccessRoleScopeImpl extends StimScopeImpl<StimRbacAccessRole, StimRbacAccessRoleSet> implements StimRbacAccessRoleScope {
