...
class StimRbacAccessPermission
    extends StimSymbol<StimRbacAccessPermission, StimRbacAccessPermissionSet> {
...
class StimRbacAccessPermissionSet extends StimSymbolSet<
    StimRbacAccessPermission, StimRbacAccessPermissionSet> {
  ...
  StimRbacAccessPermissionXResourceOp get resource {
    return _resource ??=
        StimRbacAccessPermissionXResourceOp(this, stimpack.rbac.resource);
  }
  ...
  StimRbacAccessPermissionXActionOp get action {
    return _action ??=
        StimRbacAccessPermissionXActionOp(this, stimpack.rbac.action);
  }
...
abstract class StimRbacAccessPermissionScope
    extends StimScope<StimRbacAccessPermission, StimRbacAccessPermissionSet> {
  StimRbacAccessPermission of(name, {dynamic resource, dynamic action});
}

class _StimRbacAccessPermissionScopeImpl
    extends StimScopeImpl<StimRbacAccessPermission, StimRbacAccessPermissionSet>
    implements StimRbacAccessPermissionScope {
  StimRbacResource resource;

  StimRbacAction action;

  _StimRbacAccessPermissionScopeImpl() : super();
