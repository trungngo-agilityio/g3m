...
class StimRbacAction extends StimSymbol<StimRbacAction, StimRbacActionSet> {
  StimRbacAction(_StimRbacActionScopeImpl scope) : super(scope);
...
class StimRbacActionSet
    extends StimSymbolSet<StimRbacAction, StimRbacActionSet> {
...
abstract class StimRbacActionScope
    extends StimScope<StimRbacAction, StimRbacActionSet> {
...
class _StimRbacActionScopeImpl
    extends StimScopeImpl<StimRbacAction, StimRbacActionSet>
    implements StimRbacActionScope {
  ...
  _StimRbacActionScopeImpl() : super();
