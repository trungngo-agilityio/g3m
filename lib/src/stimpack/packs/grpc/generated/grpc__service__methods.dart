...
class StimGrpcServiceXMethodsSetOp extends StimSymbolSetOpImpl<StimGrpcService,
    StimGrpcServiceSet, StimGrpcMethod, StimGrpcMethodSet> {
  StimGrpcServiceXMethodsSetOp(StimSymbolSet<StimSymbol, StimSymbolSet> symbols,
      StimGrpcMethodScope scope)
      : super(symbols, scope);
