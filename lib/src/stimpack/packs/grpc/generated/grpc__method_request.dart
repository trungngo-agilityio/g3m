...
class StimGrpcMethodRequest
    extends StimSymbol<StimGrpcMethodRequest, StimGrpcMethodRequestSet> {
  StimGrpcMethodRequest(_StimGrpcMethodRequestScopeImpl scope) : super(scope);
...
class _StimGrpcMethodRequestScopeImpl
  ...
  _StimGrpcMethodRequestScopeImpl() : super();
