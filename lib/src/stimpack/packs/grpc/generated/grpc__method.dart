...
class StimGrpcMethod extends StimSymbol<StimGrpcMethod, StimGrpcMethodSet> {
  ...
  StimGrpcMethod(_StimGrpcMethodScopeImpl scope) : super(scope);
...
class StimGrpcMethodSet
  ...
  StimGrpcMethodXRequestOp get request {
    return _request ??=
        StimGrpcMethodXRequestOp(this, stimpack.grpc.methodRequest);
  }
  ...
  StimGrpcMethodXResponseOp get response {
    return _response ??=
        StimGrpcMethodXResponseOp(this, stimpack.grpc.methodResponse);
  }
...
class _StimGrpcMethodScopeImpl
  ...
  _StimGrpcMethodScopeImpl() : super();
