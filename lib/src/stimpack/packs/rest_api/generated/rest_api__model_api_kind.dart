...
class StimRestApiModelApiKind
    extends StimSymbol<StimRestApiModelApiKind, StimRestApiModelApiKindSet> {
...
class StimRestApiModelApiKindSet
    extends StimSymbolSet<StimRestApiModelApiKind, StimRestApiModelApiKindSet> {
...
abstract class StimRestApiModelApiKindScope
    extends StimScope<StimRestApiModelApiKind, StimRestApiModelApiKindSet> {
...
class _StimRestApiModelApiKindScopeImpl
    extends StimScopeImpl<StimRestApiModelApiKind, StimRestApiModelApiKindSet>
    implements StimRestApiModelApiKindScope {
  ...
  _StimRestApiModelApiKindScopeImpl() : super();
