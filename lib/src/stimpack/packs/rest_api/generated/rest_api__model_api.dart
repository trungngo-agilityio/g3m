...
class StimRestApiModelApi extends StimSymbol<StimRestApiModelApi, StimRestApiModelApiSet> {
  StimModelType model;
  ...
  StimRestApiModelApi(_StimRestApiModelApiScopeImpl scope):
      super(scope);
...
class StimRestApiModelApiSet extends StimSymbolSet<StimRestApiModelApi, StimRestApiModelApiSet> {
  ...
  StimRestApiModelApiXIdFieldOp get idField {
    return _idField ??= StimRestApiModelApiXIdFieldOp(this, stimpack.model.field);
  }
  ...
  StimRestApiModelApiXRequestSetOp get request {
    return _request ??= StimRestApiModelApiXRequestSetOp(this, stimpack.model.type);
  }
  ...
  StimRestApiModelApiXResponseSetOp get response {
    return _response ??= StimRestApiModelApiXResponseSetOp(this, stimpack.model.field);
  }
  ...
  StimRestApiModelApiXApisSetOp get apis {
    return _apis ??= StimRestApiModelApiXApisSetOp(this, stimpack.restApi.modelApiKind);
  }
  ...
  StimRestApiModelApiXRequiredOp get required {
    return _required ??= StimRestApiModelApiXRequiredOp(this, stimpack.rbac.accessGrant);
  }
...
abstract class StimRestApiModelApiScope extends StimScope<StimRestApiModelApi, StimRestApiModelApiSet> {
  StimRestApiModelApi of(name, {dynamic model, dynamic idField, dynamic request, dynamic response, dynamic apis, dynamic required});
}


class _StimRestApiModelApiScopeImpl extends StimScopeImpl<StimRestApiModelApi, StimRestApiModelApiSet> implements StimRestApiModelApiScope {
  StimModelType model;
