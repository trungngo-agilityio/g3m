...
class StimMetaPreset extends StimSymbol<StimMetaPreset, StimMetaPresetSet> {
  ...
  StimMetaPreset._(_StimMetaPresetScopeImpl scope) : super(scope);

  @override
  StimMetaPreset clone() {
    return super.clone()..values = values.clone();
  }
}
...
class StimMetaPresetSet
  ...
  set value(StimMetaPresetXValuesSetOp value) => _values = value;
}
...
class _StimMetaPresetScopeImpl
  ...
  void clear(StimMetaPreset symbol) {
    symbol..values = __pack.value.noneSet;
  }
  ...
  @override
  StimMetaPreset of(dynamic name, {dynamic values}) {
    return createAndClear(name)..values += values ?? __pack.value.noneSet;
  }
